...
void maj_routes(t_affichage *hud, BITMAP *buffer, t_joueur *joueur, t_plateau *plateau, int lig, int col) {
    if (plateau->matrice[lig][col].element == ROUTES) {
        // TOUT LES COUDES
        if (plateau->matrice[lig - 1][col].b_element == plateau->routes[0] &&
            plateau->matrice[lig][col + 1].b_element == plateau->routes[1]) {
        ...
        if (plateau->matrice[lig - 1][col].b_element == plateau->routes[0] &&
            plateau->matrice[lig][col + 1].b_element == plateau->routes[1] &&
            plateau->matrice[lig + 1][col].b_element == plateau->routes[0]) {
...
void maj_trottoirs(t_affichage *hud, BITMAP *buffer, t_joueur *joueur, t_plateau *plateau, int lig, int col) {
    if (plateau->matrice[lig][col].element == TVAGUE) {
        printf("1");
        if (plateau->matrice[lig + 1][col + 1].element == TVAGUE ||
            plateau->matrice[lig + 1][col + 1].element == TVAGUE_CP ||
            plateau->matrice[lig + 1][col + 1].element == TVAGUE_CP_BP) {
            if (plateau->matrice[lig - 1][col - 1].element == TVAGUE ||
                plateau->matrice[lig - 1][col - 1].element == TVAGUE_CP ||
                plateau->matrice[lig - 1][col - 1].element == TVAGUE_CP_BP) {
                if (plateau->matrice[lig][col - 1].element == TVAGUE ||
                    plateau->matrice[lig][col - 1].element == TVAGUE_CP ||
                    plateau->matrice[lig][col - 1].element == TVAGUE_CP_BP) {
                    if (plateau->matrice[lig - 1][col].element == TVAGUE ||
                        plateau->matrice[lig - 1][col].element == TVAGUE_CP ||
                        plateau->matrice[lig - 1][col].element == TVAGUE_CP_BP) {
                        if (plateau->matrice[lig + 1][col].element == TVAGUE ||
                            plateau->matrice[lig + 1][col].element == TVAGUE_CP ||
                            plateau->matrice[lig + 1][col].element == TVAGUE_CP_BP) {
                            if (plateau->matrice[lig][col + 1].element == TVAGUE ||
